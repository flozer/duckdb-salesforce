...
[SMOKE.md](../SMOKE.md) validation. Use an org you are **authorized to use**
(sandbox / scratch / Developer Edition, or your own); live validation is
manual-only. Never paste any secret into an issue, chat, log, or commit.
