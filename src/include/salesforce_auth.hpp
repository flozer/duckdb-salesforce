...
public:
	...
	static SalesforceTokenSet ExchangeRefreshToken(const SalesforceConfig &config, SalesforceHttpClient &client);
	...
	static SalesforceTokenSet ExchangeJwtBearer(const SalesforceConfig &config, SalesforceHttpClient &client);
	...
	static SalesforceTokenSet AcquireToken(const SalesforceConfig &config, SalesforceHttpClient &client);
};
